function [bestMatch,artificialDoubletsCombiUnique,SVMcl,svm_score_t]=NicheSVM(pvalue_total,pCutoff,logRatio_total,lrCutoff,seedNumber,randSize,clustering,clusterSelect,clustering_name_unique,log_data_zvalue,log_data_doublets_zvalue,DEGnumber)
...
[SVMlabels,svm_score_t] = predict(SVMcl,log_data_doublets_zvalue(geneIndex2,:)');
